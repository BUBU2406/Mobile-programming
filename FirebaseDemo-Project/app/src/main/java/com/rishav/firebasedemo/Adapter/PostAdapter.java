...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.Viewholder> {
    ...
    private FirebaseUser firebaseUser;// lấy id

    public PostAdapter(Context mContext, List<Post> mPosts) {
        this.mContext = mContext;// chứa tt bài viết (postid, push,..
        this.mPosts = mPosts; //
    ...
    public void onBindViewHolder(@NonNull final Viewholder holder, int position) {
        ...
        final Post post = mPosts.get(position); // số lượng bài viết
        ...
        // tương tác comment -> CommentActivity
        ...
        // bấm vào số lượng bài viết -> CommentActivity
        ...
        // tương tác với ảnh đại diện -> frofile
        ...
        // tương tác với username -> frofile
        ...
        // tương tác với hỉnh ảnh -> PostDetailFragment
        ...
        // tương tác danh sách người like -> FollowersActivity
